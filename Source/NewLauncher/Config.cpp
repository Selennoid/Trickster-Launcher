...
namespace config
{
	...
	std::string LauncherCDN		= "cdn.ernasreborn.com.br";		// Your launcher website, without http or https
	...
	bool IsCDNUsingSSL			= false;					// Tells the launcher if your launcher update link uses SSL or not
